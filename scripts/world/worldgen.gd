...
# (Worldgen3D, vanilla px.java port) instead of the 2D heightmap.
# Toggle via env var MC_CLONE_TERRAIN_MODE=3d_density (set in game.gd).
# See .claude/terrain-shape-rework-v2.md for the rework plan.
static var terrain_3d_enabled: bool = false
